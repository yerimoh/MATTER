...
parser.add_argument('--model_name', choices=['scibert', 'MatiSciBERT_20k_orgin','matscibert', 'bert', 'ver1','ver3', 'paper'], required=True, type=str)
...
#####################
# save result
txt_name = f'128_{args.model_name}'
#####################
