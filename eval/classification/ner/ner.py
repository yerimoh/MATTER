...
#####################
# save result
txt_name ='128_0.15_MatSciBERT_paper_10K_ver2'
#####################
...
parser.add_argument('--model_name', choices=['scibert', 'matscibert', 'bert', 'New', 'MatSciBERT_100000'], required=True, type=str)
